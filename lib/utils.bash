...
list_all_versions() {
	...
	# Change this function if copier has other means of determining installable versions.
	list_github_tags
}
...
download_release() {
	...
	# TODO: Adapt the release URL convention for copier
...
install_version() {
	...
	(
		...
		# TODO: Assert copier executable exists.
		local tool_cmd
